        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewItems = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    EngDisplacement = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Fueltype = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    MaintenanceTypes = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    RimSize = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingItems_Maintenances_MaintenanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseItems", x => new { x.CarId, x.PurchaseId });
                    table.ForeignKey(
                        name: "FK_PurchaseItems_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalItems", x => new { x.CarId, x.RentalId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingItems_MaintenanceId",
                table: "BookingItems",
